...
description: AI music and song generation — songwriting craft, Suno AI prompts, HeartMuLa open-source tool, and audio visualization.
tags: [music, songwriting, audio, generation, suno, heartmula, songsee, lyrics, creative]
...
# Music Generation — Songwriting + AI Tools
...
| Topic | Location |
|:--|:--|
| Songwriting craft + Suno prompts | This file (§1–§9) |
| HeartMuLa open-source music gen (install + usage) | `references/heartmula.md` |
| SongSee audio spectrograms / feature viz | `references/songsee.md` |
...
SFX:
  [Vinyl Crackle] [Rain] [Applasue] [Static] [Thunder]
